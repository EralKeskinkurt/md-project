<template>
  <div class="relative w-[50%] h-full shadow-md overflow-y-auto overflow-x-auto">
    <table class="w-full h-auto text-sm text-left text-blue-100 relative ">
      <thead class="text-xs text-black/70 uppercase bg-green-400 sticky top-0">
      <tr>
      ...
      <tbody >
      <tr v-if="blogs"  v-for="blog in blogs" :key="blog.mdTitle" class="bg-green-600/70 h-auto border-b-[1px] border-b-green-600/60">
      ...
      <tr v-else v-for="(item, index) in 10" class="bg-green-600/70">
